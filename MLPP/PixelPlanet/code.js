...
(function() {
  ...
  1 : [function(require, canCreateDiscussions, isSlidingUp) {
    ...
    function create() {
      ...
      getInput(proto["interfaces"]["tmps"]["ctx"], ![]);
      getInput(proto["interfaces"]["sectors"]["ctx"], ![]);
      proto["interfaces"]["cover"]["draw"]();
      done();
    }
    /**
    ...
    var flag = options["getOrDefault"]("debug", ![]);
    var height = options["getOrDefault"]("grid", ![]);
    var dir = options["getOrDefault"]("sync", !![]);
    var dark = options["getOrDefault"]("sectors", ![]);
    var jqName = options["getOrDefault"]("autoSelect", ![]);
    var a = options["getOrDefault"]("phantomPxls", ![]);
    var width = options["getOrDefault"]("buffNote", !![]);
    var item = options["getOrDefault"]("detector", ![]);
    ...
    $("zoom-plus")["addEventListener"](hasTouch ? "touchend" : "mouseup", function() {
      return currentOpeningToken = ![], options["set"]("zoomlevel", b), ![];
    });
    ...
    $("zoom-minus")["addEventListener"](hasTouch ? "touchend" : "mouseup", function() {
      return c = ![], options["set"]("zoomlevel", b), ![];
    });
    if (hasTouch) {
      var a = callback({
        "type" : "canvas",
    ...
    var settings = new function() {
      ...
      this["window"] = callback({
        ...
        "</div>" + '<div id="content" style="border-bottom: 1px rgba(50,50,50,0.9) solid;">' + "</div>" + "</div>" + "<footer class='level' style = \"color:grey; font: menu; font-size:11px; padding:5px;\"></footer>"
      });
      document["body"]["appendChild"](this["window"]);
    ...
    module["exports"] = function() {
      ...
      _createClass(FalcorPubSubDataSource, [{
        ...
        value : function jsonFixer(key, value) {
          var _0x2b6b4f = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !![];
          this["data"][key] = value;
          if (_0x2b6b4f) {
            this["save"]();
          }
  ...
  17 : [function(require, module, canCreateDiscussions) {
    ...
    module["exports"] = function() {
      ...
      function Response(options) {
        ...
        this["_workAsCatcher"] = options["workAsCatcher"] || ![];
  ...
  19 : [function(canCreateDiscussions, window, isSlidingUp) {
    ...
    exports["prototype"]["addListener"] = function initDB(notify, callback) {
      return init(this, notify, callback, ![]);
    };
